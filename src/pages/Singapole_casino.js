...
<p>以上が、シンガポールから日帰りでマレーシアに旅行した際の体験記です。予期せぬ出来事もありましたが、思い出に残る一日となりました。</p>
        ...
        {/* 画像 */}
        <img src="/images/casino.jpeg" alt="ブログの画像" style={{ width: '800px', height: '700px', objectFit: 'cover' }} />
        {/* 画像の説明 */}
        <p>シンガポール動物園といえばこれ！！</p>
        ...
        {/* 画像 */}
        <img src="/images/water.jpeg" alt="ブログの画像" style={{ width: '400px', height: '400px', objectFit: 'cover' }} />
        {/* 画像の説明 */}
        <p>画像の説明をここに追加</p>
